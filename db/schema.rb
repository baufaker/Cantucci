...
ActiveRecord::Schema.define(:version => 20111206214029) do
  ...
  create_table "cardapio_categoria", :force => true do |t|
    t.string   "title"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "foto"
  ...
  create_table "cardapio_elementos", :force => true do |t|
    t.string   "title"
    t.text     "description"
  ...
  create_table "mensagem_usuarios", :force => true do |t|
    t.string   "name"
    t.string   "email"
    t.string   "phone"
    t.text     "message"
